...
twBtn.onclick = function () {
    ...
    var twHref = 'https://twitter.com/share?text=' + encodeURIComponent("今の感情を絵文字にすると\n") + '&url=' + encodeURIComponent(shareURL) + '&hashtags=' + encodeURIComponent("variemoji");
    this.href = twHref;
}
...
liBtn.onclick = function () {
    var shareURL = shareClick();
    var liHref = 'https://line.me/R/msg/text/?' + encodeURIComponent("今の感情を絵文字にすると") + ' ' + encodeURIComponent(shareURL);;
    this.href = liHref;
}